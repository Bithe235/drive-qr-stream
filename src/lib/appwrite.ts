...
// Primary Appwrite configuration
const PRIMARY_CONFIG = {
  endpoint: 'http://34.23.98.230/v1',
  projectId: '68cb051f0013a0d8aa89',
  databaseId: '68cb06140031a586fe2b',
  collectionId: '68cb061c00209aeffa1d',
  bucketId: '68cb057c002ca64682a2'
};

// Fallback Appwrite configuration
const FALLBACK_CONFIG = {
  endpoint: 'https://fra.cloud.appwrite.io/v1',
  projectId: '68ca9e8e000ddba95beb',
  databaseId: '68ca9f760003f35cf8ca',
  collectionId: 'qrcode',
  bucketId: '68caacec001fd1ff6b9d'
};
